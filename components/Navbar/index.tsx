      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex space-x-2">
            <Link href="/" onClick={(e) => handleScroll(e, undefined, '/')} className="px-4 py-2 rounded-full text-slate-800 font-medium text-sm hover:text-slate-900 hover:bg-white hover:shadow-sm hover:ring-1 hover:ring-slate-200/50 transition-all">Home</Link>
            <Link href="/#services" onClick={(e) => handleScroll(e, '#services', '/')} className="px-4 py-2 rounded-full text-slate-500 font-medium text-sm hover:text-slate-900 hover:bg-white hover:shadow-sm hover:ring-1 hover:ring-slate-200/50 transition-all">Services</Link>
            <Link href="/#jobs" onClick={(e) => handleScroll(e, '#jobs', '/')} className="px-4 py-2 rounded-full text-slate-500 font-medium text-sm hover:text-slate-900 hover:bg-white hover:shadow-sm hover:ring-1 hover:ring-slate-200/50 transition-all">Jobs</Link>
            <Link href="/#about" onClick={(e) => handleScroll(e, '#about', '/')} className="px-4 py-2 rounded-full text-slate-500 font-medium text-sm hover:text-slate-900 hover:bg-white hover:shadow-sm hover:ring-1 hover:ring-slate-200/50 transition-all">About</Link>
            <Link href="/contact" onClick={(e) => handleScroll(e, undefined, '/contact')} className="px-4 py-2 rounded-full text-slate-500 font-medium text-sm hover:text-slate-900 hover:bg-white hover:shadow-sm hover:ring-1 hover:ring-slate-200/50 transition-all">Contact</Link>
          </div>

          {/* Right CTA */}
          <div className="hidden md:flex items-center gap-3">
            <Link href="/#testimonials" onClick={(e) => handleScroll(e, '#testimonials', '/')}>
              <Button variant="outline" className="hidden lg:inline-flex border-slate-200 text-slate-700 hover:bg-slate-50">What Our Clients Say</Button>
            </Link>
