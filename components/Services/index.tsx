      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <Card className="relative rounded-none border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 ease-in-out overflow-hidden group bg-white">
            ...
            <div className="absolute bottom-0 left-0 w-full h-[3px] bg-[#a3b18a] transform origin-center scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-out z-20"></div>
            ...
            <div className="relative z-10 p-8">
              ...
              <div className="relative w-12 h-12 mb-8">
                <div className="absolute inset-0 bg-[#a3b18a] rounded-xl blur-md opacity-20 group-hover:opacity-60 transition-opacity duration-500"></div>
                <div className="relative w-12 h-12 rounded-xl bg-[#a3b18a] flex items-center justify-center shadow-md">
                  <Wallet className="text-white" size={22} />
                </div>
              </div>

              <h3 className="text-xl font-normal text-slate-900 mb-3 group-hover:text-[#a3b18a] transition-colors">Payroll Solutions</h3>
              ...
              <ul className="space-y-3">
                {["Payroll processing", "HMRC compliance", "Auto enrolment", "Digital payslips", "Reporting & analytics"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-sm text-slate-800 font-medium">
                    <CheckCircle2 size={16} className="text-[#a3b18a] shrink-0" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
          ...
          <Card className="relative rounded-none border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 ease-in-out overflow-hidden group bg-white">
            ...
            <div className="relative z-10 p-8">
              ...
              <h3 className="text-xl font-normal text-slate-900 mb-3 group-hover:text-[#a3b18a] transition-colors">Recruitment</h3>
              <p className="text-sm text-slate-700 font-medium mb-6 leading-relaxed">
          ...
          <Card className="relative rounded-none border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 ease-in-out overflow-hidden group bg-white">
            ...
            <div className="relative z-10 p-8">
              ...
              <h3 className="text-xl font-normal text-slate-900 mb-3 group-hover:text-[#a3b18a] transition-colors">Business Consulting</h3>
              <p className="text-sm text-slate-700 font-medium mb-6 leading-relaxed">
